...
const Projects = () => {
  ...
  return (
    <div id='Projects' className={`${darkMode ? "bg-[#cbd4d4]" : "bg-[#16181d]"} flex flex-col  items-center lg:h-screen mb-40 -mt-28 lg:gap-12 gap-6`}>
      <hr className='border- border-gray-400 rounded-full w-[90%]' />

      <h1 className={`lg:text-5xl font-semibold ${darkMode ? "text-black" : "text-white"}`}>My recent work</h1>
