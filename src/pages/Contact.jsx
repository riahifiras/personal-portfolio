  ...
  return (
    <div className="w-screen h-screen">
      ...
      <form onSubmit={handleSubmit} className='translate-y-20 flex flex-col justify-center items-center gap-6'>
        <h1 className='text-2xl font-semibold text-blue-700'>Contact</h1>
        ...
        <button type="submit" className='text-sm flex justify-center items-center w-96 h-11 cursor-pointer shadow-md bg-blue-700 text-white rounded-lg hover:bg-blue-600'>Send</button>
      </form>
