...
const Offer = () => {
  return (
    <div className='flex flex-row bg-gray-800 text-white rounded-3xl shadow-md justify-around items-center w-3/5 h-52 ml-auto mr-auto negative'>
        ...
        <button className='flex justify-center items-center h-10 w-40 mt-6 rounded-full bg-blue-700 text-white text-xl font-semibold hover:bg-blue-600'>Get in touch</button>
    </div>
  )
}
